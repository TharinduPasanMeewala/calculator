...
export default function ApiKeyPage() {
  ...
  function save() {
    ...
    setShowForm(false); setEditing(null); setForm({'id': '', 'user_id': '', 'key_name': '', 'key_prefix': '', 'key_hash': ''})
  }
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">ApiKey</h1>
