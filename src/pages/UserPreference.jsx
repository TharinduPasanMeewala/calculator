...
const KEY = 'userpreference-records'
...
export default function UserPreferencePage() {
  ...
  function save() {
    ...
    setShowForm(false); setEditing(null); setForm({'id': '', 'user_id': '', 'default_calculator_type': '', 'default_precision': '', 'thousands_separator': ''})
  }
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">UserPreference</h1>
